     ...
     <!-- jQuery CDN 끝 -->
      ...
      $(function(){
    	  ...
    	  $("#btn").click(function(){
    		  ...
    		  var action = "search_model.do";
    		  if( $("[name='selectAction']:checked").val() == "join_subquery" ){
    			  action="join_subquery.do";
    		  }
...
<br>
<input type="radio" value="join" checked="checked" name="selectAction">join
<input type="radio" value="join_subquery" name="selectAction">join_subquery<br>
